...
public class BoardButton extends JPanel {
	...
	public BoardButton(Board board, String imagePath) {
		...
		JLabel title = new JLabel("This is a title"); //new JLabel(board.getBoardName());
		...
		attempt.addActionListener(new SwitchPanel(CompleteTheCircuit.frame, new BoardEditor(board), "Complete the Circuit - " + board.getBoardName()));
